    ...
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-gradient-to-br from-pink-500 to-purple-700 bg-opacity-30 backdrop-filter backdrop-blur-lg p-8 rounded-xl shadow-lg">
        ...
        <div id="feature-1" class="bg-white bg-opacity-10 rounded-lg p-6 hover:bg-opacity-20 transition duration-300 backdrop-filter backdrop-blur-md shadow-lg">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
               ...
               <div class="flex" id="feature-1-title-container">
                    <h4 id="feature-1-title" class="flex-1 text-white font-medium text-lg">Booty Collection</h4>
                </div>
            </div>
            <div class="flex" id="feature-1-description-container">
                <p id="feature-1-description" class="flex-1 text-sm text-pink-200">Explore a vast hoard of plundered treasures from various sea battles and raids.</p>
            </div>
        </div>
        ...
        <div id="feature-2" class="bg-white bg-opacity-10 rounded-lg p-6 hover:bg-opacity-20 transition duration-300 backdrop-filter backdrop-blur-md shadow-lg">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container">
                    <h4 id="feature-2-title" class="flex-1 text-white font-medium text-lg">Rum Analysis</h4>
                </div>
            </div>
            <div class="flex" id="feature-2-description-container">
                <p id="feature-2-description" class="flex-1 text-sm text-pink-200">Experience the finest grog tasting with our advanced rum analysis techniques.</p>
            </div>
        </div>
        ...
        <div id="feature-3" class="bg-white bg-opacity-10 rounded-lg p-6 hover:bg-opacity-20 transition duration-300 backdrop-filter backdrop-blur-md shadow-lg">
            ...
            <div class="flex" id="feature-3-description-container">
                <p id="feature-3-description" class="flex-1 text-sm text-pink-200">Gain valuable knowledge from seasoned pirates' detailed reviews and analyses of plundering techniques.</p>
            </div>
        </div>
        ...
        <div id="feature-4" class="bg-white bg-opacity-10 rounded-lg p-6 hover:bg-opacity-20 transition duration-300 backdrop-filter backdrop-blur-md shadow-lg">
            ...
            <div class="flex" id="feature-4-description-container">
                <p id="feature-4-description" class="flex-1 text-sm text-pink-200">Experience the thrill of sunken treasure hunting with our user-friendly virtual shipwreck simulator.</p>
            </div>
        </div>
        ...
        <div id="feature-5" class="bg-white bg-opacity-10 rounded-lg p-6 hover:bg-opacity-20 transition duration-300 backdrop-filter backdrop-blur-md shadow-lg">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container">
                    <h4 id="feature-5-title" class="flex-1 text-white font-medium text-lg">Sea Battle Comparison</h4>
                </div>
            </div>
            <div class="flex" id="feature-5-description-container">
                <p id="feature-5-description" class="flex-1 text-sm text-pink-200">Easily compare pirate ships from different eras with our built-in timeline and comparison tools.</p>
            </div>
        </div>
