<template>
  <header class="w-full z-30 bg-gradient-to-r from-pink-500 to-purple-600 bg-opacity-30 backdrop-filter backdrop-blur-lg shadow-lg rounded-lg" id="header-section-container" style="min-height: 230px">
